package com.ryan.core.widget.banner;
...
import com.ryan.core.widget.banner.loader.OnBannerListener;
import com.ryan.core.widget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public Banner setTitleVisible(int isVisible) {
        bannerTitle.setVisibility(isVisible);
        titleView.setVisibility(isVisible);
        return this;
    }
    ...
    private void setImageList(List<?> imagesUrl) {
        ...
        Log.e(tag, "The image data  "+imagesUrl.size());
