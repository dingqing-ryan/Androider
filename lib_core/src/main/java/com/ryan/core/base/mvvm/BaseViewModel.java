...
import com.ryan.core.helper.SingleLiveEvent;
...
import static com.ryan.core.utils.ListUtils.isListNotNull;
...
//    }
    ...
    public void dismissDialog() {
        SystemClock.sleep(280);//弹窗效果好点，不然一闪一闪的
    ...
    protected void startContainerActivity(String canonicalName, Bundle bundle) {
        Log.i("startContainerActivity","canonicalName---"+canonicalName);
        Map<String, Object> params = new HashMap<>();
    ...
    public void setPage(ObservableArrayList mList,boolean isRefresh){
        ...
        Log.i("setPage","下一次请求的分页数："+mPage.get());
    }
}
